          ...
          <div className="lg:col-span-2 flex flex-col gap-5">
            ...
            <div className="flex flex-col gap-2.5 text-xs text-gray-300">
              <div className="flex items-center gap-3">
                ...
                <a href="tel:+6281281260149" className="hover:text-white transition-colors no-underline">+62 812-8126-0149</a>
              </div>
              <div className="flex items-center gap-3">
                <Phone size={14} className="text-[#4472C4]" />
                <a href="tel:+6285382160110" className="hover:text-white transition-colors no-underline">+62 853-8216-0110</a>
              </div>
              <div className="flex items-center gap-3 mt-1">
                <Mail size={14} className="text-[#4472C4]" />
                <a href="mailto:info@DutaJayaEkspress.com" className="hover:text-white transition-colors no-underline">info@DutaJayaEkspress.com</a>
              </div>
            </div>
          </div>
