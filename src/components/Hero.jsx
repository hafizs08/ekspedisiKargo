...
/>
  ...
  data-aos="fade-right">
                    ...
                    <div className="flex flex-wrap items-center gap-4 mb-10">
                        <button className="px-6 py-3.5 bg-[#4472C4] text-white rounded-xl text-sm font-semibold hover:bg-[#365fa3] transition-colors flex items-center gap-2 cursor-pointer border-none shadow-lg shadow-[#4472C4]/20 dark:bg-blue-600 dark:hover:bg-blue-700">
                            <Package size={18} />
                            Kirim Sekarang
                        </button>
                        <button className="px-6 py-3.5 bg-white border border-[#D1DCF0] text-gray-700 rounded-xl text-sm font-medium hover:border-[#4472C4] hover:text-[#4472C4] transition-all cursor-pointer flex items-center gap-1 dark:bg-slate-800 dark:border-slate-700 dark:text-slate-200 dark:hover:text-blue-400 dark:hover:border-blue-500">
                    ...
                    <div className="flex items-center gap-6 sm:gap-10 border-t border-gray-100 pt-8 dark:border-slate-800">
                        <div>
                            <div className="text-2xl font-extrabold text-[#1F2E4D] dark:text-white">2.4M+</div>
